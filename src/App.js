...
const styles = {
  ...
  main: { flex: 1, backgroundColor: '#1a1a1a', borderRadius: '40px', padding: '20px', border: '1px solid #333', marginTop: '10px', display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }
};
